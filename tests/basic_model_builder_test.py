...
with tf.Session() as session:
    ...
    # statistic
    test_output(
        session, statistic_output, statistic_feed_dict, statistic_training)
    ...
    test_batch_normalization(
        session, update_output, update_feed_dict, update_training)
    test_preserving_batch_normalization_state(
        session, update_output, update_feed_dict, update_training,
        collected_untrainable_variables, set_untrainable_variables,
        set_untrainable_variables_input)
    ...
    # move_rate
    test_output(
        session, move_rate_output, move_rate_feed_dict, move_rate_training)
    test_batch_normalization(
        session, move_rate_output, move_rate_feed_dict, move_rate_training)
    test_preserving_batch_normalization_state(
        session, move_rate_output, move_rate_feed_dict, move_rate_training,
